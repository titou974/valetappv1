            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-neutral p-6 text-center align-middle shadow-xl transition-all">
                  ...
                  <p className="text-base font-light text-neutral_content mt-2">
                    Patientez quelques secondes...
                  </p>
                  <div className="flex-col gap-4 w-full flex items-center justify-center mt-6">
                    <div className="w-16 h-16 border-8 text-primary text-4xl animate-spin border-gray-300 flex items-center justify-center border-t-primary rounded-full">
